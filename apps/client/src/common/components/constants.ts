export const COLOR_PRIMARY = '#bf268a'
export const COLOR_SECONDARY = '#04d9b2'
...
export const PRIMARY_BOX_SHADOW = '0px 4px 4px rgba(0, 0, 0, 0.25)'

export const FONT_URL =
  'https://fonts.googleapis.com/css?family=Caveat:400,700|Raleway:400,700'
